...
void WRPG_mainLoop() {
    ...
    WRPG_sprite actorSprite;
    WRPG_initSprite(&actorSprite, gRenderer);
    WRPG_loadSprite(&actorSprite, "../../test_assets/test13/Actor3.png");
    ...
    while(!stop) {
        ...
        WRPG_renderSprite(&actorSprite, 0, 0, currentClip);
